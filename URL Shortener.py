...
Label(window, text="Generate Short URL", font=(
    "Arial", 25, "bold"), fg="Purple").pack(pady=10)
...
Button(window, text="Generate Link", font=("arial", 15,
                                           "bold"), command=shortener).pack(pady=10)

frame2 = Frame(window)

Label(frame2, text="Copy URL: ", font=("arial", 15, "bold")).pack(side="left")
